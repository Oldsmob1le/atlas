...
<body class="min-h-[100dvh] w-full flex bg-zinc-50 text-zinc-950">
    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center px-6 sm:px-12 md:px-20 xl:px-32 relative z-10">
        <div class="w-full max-w-md mx-auto">
            <div class="mb-10">
                ...
                <p class="text-base text-zinc-500 leading-relaxed max-w-[65ch]">С возвращением. Пожалуйста, войдите в свой аккаунт.</p>
            </div>
    ...
    <div class="hidden lg:flex w-1/2 bg-zinc-950 relative overflow-hidden p-8 flex-col justify-between">
        <img src="https://picsum.photos/seed/atlas-login/1200/1600" alt="" class="absolute inset-0 w-full h-full object-cover opacity-40 mix-blend-luminosity pointer-events-none">
        ...
        <div class="relative z-10 pt-8 pl-8 text-white/40 font-mono text-sm">
            SYS.ATLAS // AUTH_MODULE
        </div>
        
        <div class="relative z-10 pb-12 pl-8 pr-12 max-w-lg">
            <h2 class="text-4xl md:text-5xl tracking-tighter text-white leading-none mb-6">Продолжите<br>свою работу.</h2>
